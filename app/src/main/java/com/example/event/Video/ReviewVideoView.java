 ...
 * 视频播放view
 */
public class ReviewVideoView extends TextureView implements TextureView.SurfaceTextureListener {
	...
	public ReviewVideoView(Context context, AttributeSet attrs, int defStyle) {
	...
	public ReviewVideoView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initVideoView();
	}
